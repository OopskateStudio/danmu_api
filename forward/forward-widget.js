...
WidgetMetadata = {
  ...
  globalParams: [
    ...
    {
      name: "sourceOrder",
      title: "源排序配置，默认'360,tencent,iqiyi,youku,bilibili,dandan'，可选['360', 'vod', 'tmdb', 'douban', 'tencent', 'youku', 'iqiyi', 'imgo', 'bilibili', 'migu', 'sohu', 'leshi', 'xigua', 'maiduidui', 'aiyifan', 'renren', 'hanjutv', 'bahamut', 'dandan', 'custom']",
      type: "input",
      placeholders: [
        {
          title: "配置1",
        ...
        {
          title: "配置2（推荐）",
          value: "360,tencent,iqiyi,youku,bilibili,dandan",
        },
        {
          title: "配置3",
